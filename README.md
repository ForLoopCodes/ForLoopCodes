<img width="539" height="192" alt="forloop" src="https://github.com/user-attachments/assets/6f75089a-6d59-4a4d-a207-78e930e10d7d" /><p>

[`x`](https://twitter.com/forloopcodes) . [`github`](https://github.com/ForLoopCodes) . [`youtube`](https://youtube.com/@forloopcodes)

`context+ 1.2k*` . `legacy-notepad 480*` . `termhunt` . `phoneagent`
